...
### 🚀 [TourBuddy](https://www.ijraset.com/research-paper/tourbuddy-a-tour-guide)  
💡 A smart travel chatbot using **React, Node.js, ChatGPT API & MongoDB** for personalized recommendations.  
🔹 Enhanced response times by **15%** with optimized API requests.  

### 🖼️ Cotton Leaf Disease Detection System  
🌱 AI-powered **CNN model** achieving **95% accuracy** in detecting 5+ cotton leaf diseases.  
🔹 Integrated **TensorFlow & OpenCV** for advanced image processing.  

### 🌍 Public Informational Website for Panvel Municipal Corporation  
🏛️ Designed a **solid waste management portal** improving community engagement by **35%**.  
🔹 Built a **responsive UI** with **React & Bootstrap**, improving accessibility across devices.  
